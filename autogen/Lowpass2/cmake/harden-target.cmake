...
# Options: SCOPE <PRIVATE|PUBLIC>     -- propagation of compile options (default
# PRIVATE) WARNINGS <ON|OFF>          -- add common warning sets (default ON for
# GNU/Clang, /W4 /sdl for MSVC) SANITIZERS <ASAN;UBSAN;...>-- list; empty = off
# FORTIFY <0|1|2|3>          -- glibc fortify level on ELF (default 3 if
# possible) PIE <AUTO|ON|OFF>          -- position independent executable on ELF
# (default AUTO) RELRO <AUTO|FULL|PARTIAL|OFF> -- default AUTO SPECTRE
# <AUTO|ON|OFF>      -- /Qspectre (MSVC)/-mspeculative-load-hardening (Clang) if
# supported
function(harden_target tgt)
  ...
  cmake_parse_arguments(H "${options}" "${oneValueArgs}" "${multiValueArgs}"
                        ${ARGN})
  ...
  if(WIN32)
    if(IS_MSVC_STYLE)
      ...
      _add_ldflag_if(${tgt} "/guard:ehcont")
    ...
    if(H_FORTIFY GREATER 0)
      target_compile_definitions(${tgt} ${H_SCOPE}
                                        "_FORTIFY_SOURCE=${H_FORTIFY}")
    endif()
